...
export const ENV = {
  ...
  USDC_SOL_WHIRLPOOL_ADDRESS: getPublicKeyFromEnv('USDC_SOL_WHIRLPOOL_ADDRESS', true),
  
  // Token mints
  SOL_MINT: getPublicKeyFromEnv('SOL_MINT', true),
  USDC_MINT: getPublicKeyFromEnv('USDC_MINT', true),
